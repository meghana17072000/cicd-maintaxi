def registry = 'https://trialph251g.jfrog.io/artifactory'
def imageName = 'trialph251g.jfrog.io/taxiapp-docker-local/taxiapp'
def version   = '1.0.1'
pipeline {
    agent {
        node {
        ...
        stage('SonarQube Analysis') {
            steps {
                script {
                    ...
                    -Dsonar.projectKey=taxi-app0004_taxi-app \
                    -Dsonar.organization=taxi-app0004 \
